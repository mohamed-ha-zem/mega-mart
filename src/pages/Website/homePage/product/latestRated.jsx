...
export default function LatestRated(){
        ...
        useEffect(() => {
            Axios.get(`${LatestRatedProducts}`).then((data) => setProducts(data.data)).finally(() => setLoading(false))
        } , [])
    return(
        <div className="border-4 border-blue-700 mb-4 ml-7">
            <h1 className="font-bold text-slate-100 bg-blue-700 px-20 py-3">Latest Rated</h1>
